  ...
  return (
    ...
    <div className='w-[90%] mx-auto mt-10'>
      <div className='flex flex-wrap justify-around items-center p-10'>
        <div className='text-3xl text-center md:text-left md:text-6xl font-semibold'>
      ...
      <div className='w-[85%] mx-auto'>
        <p className='mb-16 text-justify md:text-center text-md md:text-xl'>
      ...
      <div>
        <p className='text-center text-md md:text-xl text-[#114AA4] underline'>Choose Your Department</p>
      </div>
        ...
        {Object.entries(imagePath).map(([key, path]) => (
          <div key={key} className="flex flex-col items-center justify-center">
            <img 
              src={path} 
              alt={`Image ${key}`} 
              className=" object-contain aspect-square hover:scale-[1.05] transition-transform duration-300 cursor-pointer" 
            />
    ...
    <div className='flex flex-col items-center justify-center'>
        <p className='text-center text-xl cursor-pointer hover:underline my-10 hover:scale-[1.09] duration-500'>Department not listed here?</p>
