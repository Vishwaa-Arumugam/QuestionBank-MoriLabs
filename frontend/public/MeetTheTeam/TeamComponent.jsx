    ...
    return (
        <>
            <div className="profiles">
                ...
                <RectangleProfile name="Vishnu Siddharth" imageLink="/src/assets/Vishnu Siddharth.png" githubLink='https://github.com/HallowSiddharth' linkedinLink='https://www.linkedin.com/in/vishnusiddharth/' instagramLink='https://www.instagram.com/vishnusiddharthvr/' />
